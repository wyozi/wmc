...
local function FormatSimpleTime(seconds, fmt)
...
hook.Add("HUDPaint", "WyoziMCDefaultHUD", function()
	...
	local t = FormatSimpleTime(elapsed, "%02i:%02i")
	if qd.Duration and qd.Duration ~= -1 then
		t = t .. " / " .. FormatSimpleTime(qd.Duration, "%02i:%02i")
	end
...
hook.Add("Think", "WyoziMCDamageLogHotkey", wyozimc.HKThink)